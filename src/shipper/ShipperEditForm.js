...
class ShippingEditForm extends Component {
                        ...
                        <div>
                            ...
                            {rData.map((item, i) => {
                                return (<div key={i} className="text-center">
                                    <input type="text" name="location" defaultValue={item.location} placeholder="Enter service location" className="col-3 mr-1" />
                                    <input type="text" name="destination" defaultValue={item.destination} placeholder="Enter service destination" className="col-3 mr-1" />
                                    <input type="text" name="fee" defaultValue={item.fee} placeholder="Enter service charge" className="col-3 mr-1" />
